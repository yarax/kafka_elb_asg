...
aws cloudformation deploy --profile thinkport --region eu-central-1 --template-file ./cloudformation/asg.yaml --stack-name KafkaDemoCluster2 --parameter-overrides UserData=$(cat ./dynamic_ips.sh | base64)
