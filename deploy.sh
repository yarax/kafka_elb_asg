...
aws cloudformation deploy --profile thinkport --region eu-central-1 --template-file ./cloudformation/asg.yaml --stack-name KafkaDemoCluster --parameter-overrides UserData=$(cat ./userdata.sh | base64)
